...
def main():
    ...
    # Set title with a colored background
    ...
    # Latest News section with conditional background color
    ...
    # Disease Information section with dropdown background color
    ...
    # Prevention Tips section with colored list
    ...
    # Contact Us section with colored background
